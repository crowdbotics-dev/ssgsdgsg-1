...
class NewConnectorViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_NEW_CONNECTOR_PASSWORD
    USERNAME = settings.CONNECTOR_NEW_CONNECTOR_USERNAME
    BASE_URL = "https://cbdash-pr-5028.herokuapp.com/dashboard/app/1/connectors"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_NEW_CONNECTOR"
